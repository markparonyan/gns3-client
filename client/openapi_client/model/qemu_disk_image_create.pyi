...
class QemuDiskImageCreate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def format() -> typing.Type['QemuDiskImageFormat']:
                return QemuDiskImageFormat
    ...
    format: 'QemuDiskImageFormat'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["format"]) -> 'QemuDiskImageFormat': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["format", "size", "preallocation", "cluster_size", "refcount_bits", "lazy_refcounts", "subformat", "static", "zeroed_grain", "adapter_type", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["format"]) -> 'QemuDiskImageFormat': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["format", "size", "preallocation", "cluster_size", "refcount_bits", "lazy_refcounts", "subformat", "static", "zeroed_grain", "adapter_type", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        size: typing.Union[MetaOapg.properties.size, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        format: 'QemuDiskImageFormat',
