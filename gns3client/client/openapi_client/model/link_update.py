...
class LinkUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nodes", "suspend", "link_style", "filters", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nodes", "suspend", "link_style", "filters", ], str]):
