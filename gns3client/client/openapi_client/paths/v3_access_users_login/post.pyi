...
# body param
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BodyLoginV3AccessUsersLoginPost
...
class BaseApi(api_client.Api):
    @typing.overload
    def _login_v3_access_users_login_post_oapg(
        self,
...
class LoginV3AccessUsersLoginPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def login_v3_access_users_login_post(
        self,
        content_type: typing_extensions.Literal["application/x-www-form-urlencoded"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationXWwwFormUrlencoded, schemas.Unset] = schemas.unset,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def login_v3_access_users_login_post(
        ...
        return self._login_v3_access_users_login_post_oapg(
            body=body,
