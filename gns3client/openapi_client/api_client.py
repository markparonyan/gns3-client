...
from gns3client.openapi_client import rest
from gns3client.openapi_client.configuration import Configuration
from gns3client.openapi_client.exceptions import ApiTypeError, ApiValueError
from gns3client.openapi_client.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
