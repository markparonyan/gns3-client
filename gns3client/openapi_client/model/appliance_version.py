...
class ApplianceVersion(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["idlepc"]) -> MetaOapg.properties.idlepc: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "idlepc", "images", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["idlepc"]) -> typing.Union[MetaOapg.properties.idlepc, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "idlepc", "images", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        idlepc: typing.Union[MetaOapg.properties.idlepc, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
