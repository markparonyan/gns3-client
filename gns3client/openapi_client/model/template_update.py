...
class TemplateUpdate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            template_type = schemas.AnyTypeSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["template_type"]) -> MetaOapg.properties.template_type: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["template_id"], typing_extensions.Literal["name"], typing_extensions.Literal["version"], typing_extensions.Literal["category"], typing_extensions.Literal["default_name_format"], typing_extensions.Literal["symbol"], typing_extensions.Literal["template_type"], typing_extensions.Literal["compute_id"], typing_extensions.Literal["usage"], str, ]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["template_type"]) -> typing.Union[MetaOapg.properties.template_type, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        template_type: typing.Union[MetaOapg.properties.template_type, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
