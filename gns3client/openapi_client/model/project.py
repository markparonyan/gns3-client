...
class Project(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["project_id", "name", "path", "auto_close", "auto_open", "auto_start", "scene_height", "scene_width", "zoom", "show_layers", "snap_to_grid", "show_grid", "grid_size", "drawing_grid_size", "show_interface_labels", "supplier", "variables", "status", "filename", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["project_id", "name", "path", "auto_close", "auto_open", "auto_start", "scene_height", "scene_width", "zoom", "show_layers", "snap_to_grid", "show_grid", "grid_size", "drawing_grid_size", "show_interface_labels", "supplier", "variables", "status", "filename", ], str]):
