...
class TemplateUsage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["x", "y", "name", "compute_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["x", "y", "name", "compute_id", ], str]):
