...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_v3_projects_project_id_get_oapg(
        self,
...
class GetProjectV3ProjectsProjectIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_project_v3_projects_project_id_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_project_v3_projects_project_id_get(
        ...
        return self._get_project_v3_projects_project_id_get_oapg(
